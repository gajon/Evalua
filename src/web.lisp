...
(define-index-fn
  ;;
  ;;
  (standard-page (:title "Evalua.mx - La manera más fácil y rápida de crear exámenes en línea."
                  :css-files ("index.css"))
    ;;
    ...
    (:section :id "middle-section"
      (:div :class "left"
        (:h1 "La manera más fácil y rápida de crear exámenes en línea.")
        (:hr)
        (:ol
          (:li "Diseña tu evaluación, creando preguntas y sus respuestas.")
          (:li "Envíalo por correo electrónico o publicalo en tu página web.")
    ...
    (:section :id "more-features"
      (:div :class "left"
        (:h2 "¿Para qué sirve?")
        (:ul
          (:li "Evaluar y reforzar los procesos de ingreso y capacitación
               laboral.")
          (:li "Aplicar encuestas de satisfacción y mejora a los empleados y
               clientes de mi empresa.")
          (:li "Aplicar exámenes y ejercicios de práctica a mis alumnos.")))
      (:div :class "right"
        (:h2 "Características")
        (:ul
          ...
          (:li "Envía la evaluación a través de correo electrónico o
               publicala en tu página de Internet, Blog, Facebook, Twitter,
               etc.")
          (:li (:a :href "/features" "Ver mas ..."))))
      (:div :class "clear"))))
